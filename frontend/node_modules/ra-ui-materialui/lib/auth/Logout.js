...
var LogoutWithRef = React.forwardRef(function Logout(props, ref) {
    ...
    return (React.createElement(core_1.MenuItem, __assign({ className: (0, classnames_1.default)('logout', classes.menuItem, className), onClick: handleClick, ref: ref, component: isXSmall ? 'span' : 'li' }, rest),
