...
var DeleteWithConfirmButton = function (props) {
    ...
    var mode = (0, ra_core_1.getMutationMode)(mutationMode, undoable);
    var _f = (0, ra_core_1.useDeleteWithConfirmController)({
        record: record,
        redirect: redirect,
        basePath: basePath,
    ...
    return (react_1.default.createElement(react_1.Fragment, null,
        react_1.default.createElement(Button_1.default, __assign({ onClick: handleDialogOpen, label: label, className: (0, classnames_1.default)('ra-delete-button', classes.deleteButton, className), key: "button" }, rest), icon),
