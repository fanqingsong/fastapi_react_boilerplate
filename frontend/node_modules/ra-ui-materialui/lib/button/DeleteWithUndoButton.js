...
var DeleteWithUndoButton = function (props) {
    ...
    return (React.createElement(Button_1.default, __assign({ onClick: handleDelete, disabled: loading, label: label, className: (0, classnames_1.default)('ra-delete-button', classes.deleteButton, className), key: "button" }, rest), icon));
};
