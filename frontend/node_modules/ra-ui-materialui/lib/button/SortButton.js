...
var SortButton = function (props) {
    ...
    var _c = (0, ra_core_1.useListSortContext)(), resource = _c.resource, currentSort = _c.currentSort, setSort = _c.setSort;
    ...
    var buttonLabel = translate(label, {
        field: translate.apply(void 0, (0, ra_core_1.getFieldLabelTranslationArgs)({
            resource: resource,
