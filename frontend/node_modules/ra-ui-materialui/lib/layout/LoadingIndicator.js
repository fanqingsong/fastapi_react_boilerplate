...
var LoadingIndicator = function (props) {
    ...
    (0, ra_core_1.useRefreshWhenVisible)();
    var loading = (0, react_redux_1.useSelector)(function (state) { return state.admin.loading > 0; });
    var classes = useStyles(props);
    var theme = (0, styles_1.useTheme)();
    return loading ? (React.createElement(CircularProgress_1.default, __assign({ className: (0, classnames_1.default)('app-loader', classes.loader, className), color: "inherit", size: theme.spacing(2), thickness: 6 }, rest))) : (React.createElement(RefreshIconButton_1.default, { className: classes.loadedIcon }));
};
