...
var EmailField = (0, react_1.memo)(function (props) {
    ...
    return (React.createElement(core_1.Link, __assign({ className: className, href: "mailto:" + value, onClick: stopPropagation, variant: "body2" }, (0, sanitizeFieldRestProps_1.default)(rest)), value));
});
