...
var ImageField = function (props) {
    ...
    if (Array.isArray(sourceValue)) {
        return (React.createElement("ul", __assign({ className: (0, classnames_1.default)(classes.list, className) }, (0, sanitizeFieldRestProps_1.default)(rest)), sourceValue.map(function (file, index) {
