...
var ReferenceField = function (props) {
    ...
    return (0, get_1.default)(record, source) == null ? (emptyText ? (React.createElement(core_1.Typography, { component: "span", variant: "body2" }, emptyText)) : null) : (React.createElement(exports.NonEmptyReferenceField, __assign({}, rest, { record: record, source: source })));
};
...
var NonEmptyReferenceField = function (_a) {
    ...
    var resourceLinkPath = (0, ra_core_1.getResourceLinkPath)(__assign(__assign({}, props), { resource: resource, record: record, source: source, basePath: basePath }));
    return (React.createElement(ra_core_1.ResourceContextProvider, { value: reference },
        React.createElement(PureReferenceFieldView, __assign({}, props, (0, ra_core_1.useReference)({
            reference: reference,
...
var ReferenceFieldView = function (props) {
    ...
    return (React.createElement(ra_core_1.RecordContextProvider, { value: referenceRecord }, (0, react_1.cloneElement)(react_1.Children.only(children), __assign({ record: referenceRecord, resource: reference, basePath: basePath, translateChoice: translateChoice }, (0, sanitizeFieldRestProps_1.default)(rest)))));
};
