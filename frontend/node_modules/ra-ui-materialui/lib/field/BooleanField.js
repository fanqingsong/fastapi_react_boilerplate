...
var BooleanField = (0, react_1.memo)(function (props) {
    ...
    if (looseValue || value === false || value === true) {
        return (React.createElement(core_1.Typography, __assign({ component: "span", variant: "body2", className: (0, classnames_1.default)(classes.root, className) }, (0, sanitizeFieldRestProps_1.default)(rest)),
    ...
    return (React.createElement(core_1.Typography, __assign({ component: "span", variant: "body2", className: className }, (0, sanitizeFieldRestProps_1.default)(rest)), emptyText));
});
