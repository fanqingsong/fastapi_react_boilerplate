...
exports.SelectField = (0, react_1.memo)(function (props) {
    ...
    if (!choice) {
        return emptyText ? (React.createElement(core_1.Typography, __assign({ component: "span", variant: "body2", className: className }, (0, sanitizeFieldRestProps_1.default)(rest)), emptyText)) : null;
    }
    var choiceText = getChoiceText(choice);
    return (React.createElement(core_1.Typography, __assign({ component: "span", variant: "body2", className: className }, (0, sanitizeFieldRestProps_1.default)(rest)), choiceText));
});
