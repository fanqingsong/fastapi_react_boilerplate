...
exports.ChipField = (0, react_1.memo)(function (props) {
    ...
    return (React.createElement(Chip_1.default, __assign({ className: (0, classnames_1.default)(classes.chip, className), label: value }, (0, sanitizeFieldRestProps_1.default)(rest))));
});
