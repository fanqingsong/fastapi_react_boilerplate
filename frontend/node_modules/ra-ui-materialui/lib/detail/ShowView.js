...
var ShowView = function (props) {
    ...
    var _b = (0, ra_core_1.useShowContext)(props), basePath = _b.basePath, defaultTitle = _b.defaultTitle, hasList = _b.hasList, record = _b.record, resource = _b.resource, version = _b.version;
    ...
    return (React.createElement("div", __assign({ className: (0, classnames_1.default)('show-page', classes.root, className) }, sanitizeRestProps(rest)),
