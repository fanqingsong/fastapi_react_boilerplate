...
var CreateView = function (props) {
    ...
    var _b = (0, ra_core_1.useCreateContext)(props), basePath = _b.basePath, defaultTitle = _b.defaultTitle, hasList = _b.hasList, record = _b.record, redirect = _b.redirect, resource = _b.resource, save = _b.save, saving = _b.saving, version = _b.version;
    return (React.createElement("div", __assign({ className: (0, classnames_1.default)('create-page', classes.root, className) }, sanitizeRestProps(rest)),
