...
var FileInput = function (props) {
    ...
    return (react_1.default.createElement(Labeled_1.default, __assign({ id: id, label: label, className: (0, classnames_1.default)(classes.root, className), source: source, resource: resource, isRequired: isRequired, meta: meta }, (0, sanitizeInputRestProps_1.default)(rest)),
