...
var DateInput = function (_a) {
    ...
    var _e = (0, ra_core_1.useInput)(__assign({ defaultValue: defaultValue, format: format, initialValue: initialValue, name: name, onBlur: onBlur, onChange: onChange, onFocus: onFocus, parse: parse, resource: resource, source: source, validate: validate }, rest)), id = _e.id, input = _e.input, isRequired = _e.isRequired, meta = _e.meta;
