...
var AutocompleteSuggestionList = function (props) {
    ...
    return (React.createElement(core_1.Popper, __assign({ open: isOpen, anchorEl: inputEl, className: (0, classnames_1.default)(classes.suggestionsContainer, className), modifiers: {} }, suggestionsContainerProps),
