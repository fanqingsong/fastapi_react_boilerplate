...
var ReferenceArrayInput = function (_a) {
    ...
    var _b = (0, ra_core_1.useInput)(__assign({ id: idOverride, onBlur: onBlur, onChange: onChange, onFocus: onFocus, source: props.source, validate: validate, parse: parse, format: format }, props)), id = _b.id, input = _b.input, isRequired = _b.isRequired, meta = _b.meta;
    var controllerProps = (0, ra_core_1.useReferenceArrayInputController)(__assign(__assign({}, props), { input: input }));
...
var ReferenceArrayInputView = function (_a) {
    ...
    var translatedLabel = translate.apply(void 0, (0, ra_core_1.getFieldLabelTranslationArgs)({
        label: label,
        resource: resource,
        source: source,
    }));
