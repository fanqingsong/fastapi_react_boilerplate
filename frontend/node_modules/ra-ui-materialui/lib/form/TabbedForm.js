...
var TabbedForm = function (props) {
    var match = (0, react_router_1.useRouteMatch)();
    var location = (0, react_router_1.useLocation)();
    var formRootPathname = match ? match.url : location.pathname;
    return (React.createElement(ra_core_1.FormWithRedirect, __assign({}, props, { formRootPathname: formRootPathname, render: function (formProps) { return React.createElement(TabbedFormView_1.TabbedFormView, __assign({}, formProps)); } })));
};
