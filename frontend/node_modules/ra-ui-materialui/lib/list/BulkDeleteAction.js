...
var BulkDeleteAction = function (props) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (undoable) {
            dispatch((0, ra_core_1.startUndoable)((0, ra_core_1.crudDeleteMany)(resource, selectedIds, basePath)));
        }
        else {
            dispatch((0, ra_core_1.crudDeleteMany)(resource, selectedIds, basePath));
        }
        onExit();
