...
var SimpleList = function (props) {
    ...
    var _b = (0, ra_core_1.useListContext)(props), basePath = _b.basePath, data = _b.data, ids = _b.ids, loaded = _b.loaded, total = _b.total;
    ...
    return (total > 0 && (React.createElement(core_1.List, __assign({ className: className }, (0, ra_core_1.sanitizeListRestProps)(rest)), ids.map(function (id, rowIndex) { return (React.createElement(ra_core_1.RecordContextProvider, { key: id, value: data[id] },
...
var useLinkOrNotStyles = (0, styles_1.makeStyles)({
    link: {},
}, { name: 'RaLinkOrNot' });
var LinkOrNot = function (props) {
    ...
    return link === 'edit' || link === true ? (React.createElement(core_1.ListItem, __assign({ button: true, 
        // @ts-ignore
        component: react_router_dom_1.Link, to: (0, ra_core_1.linkToRecord)(basePath, id), className: classes.link }, rest), children)) : link === 'show' ? (React.createElement(core_1.ListItem, __assign({ button: true, 
        // @ts-ignore
        component: react_router_dom_1.Link, to: (0, ra_core_1.linkToRecord)(basePath, id) + "/show", className: classes.link }, rest), children)) : link !== false ? (React.createElement(core_1.ListItem, __assign({ button: true, 
        // @ts-ignore
        component: react_router_dom_1.Link, to: link, className: classes.link }, rest), children)) : (React.createElement(core_1.ListItem
    // @ts-ignore
    , __assign({ 
        // @ts-ignore
