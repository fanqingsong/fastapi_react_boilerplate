...
var ListActions = function (props) {
    ...
    var _a = (0, ra_core_1.useListContext)(props), currentSort = _a.currentSort, displayedFilters = _a.displayedFilters, filterValues = _a.filterValues, basePath = _a.basePath, showFilter = _a.showFilter, total = _a.total;
    ...
    return (0, react_1.useMemo)(function () { return (React.createElement(TopToolbar_1.default, __assign({ className: className }, (0, ra_core_1.sanitizeListRestProps)(rest)),
        ...
        exporter !== false && (React.createElement(button_1.ExportButton, { disabled: total === 0, resource: resource, sort: currentSort, filterValues: filterValues })))); }, 
