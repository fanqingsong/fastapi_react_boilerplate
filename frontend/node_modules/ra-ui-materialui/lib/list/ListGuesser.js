...
var ListGuesser = function (props) {
    var controllerProps = (0, ra_core_1.useListController)(props);
...
var ListViewGuesser = function (props) {
    ...
    (0, react_1.useEffect)(function () {
        if (ids.length > 0 && data && !inferredChild) {
            var inferredElements = (0, ra_core_1.getElementsFromRecords)(ids.map(function (id) { return data[id]; }), listFieldTypes_1.default);
