...
var DatagridRow = react_1.default.forwardRef(function (props, ref) {
    ...
    var _b = (0, ra_core_1.useExpanded)(resource, id), expanded = _b[0], toggleExpanded = _b[1];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    switch (effect) {
                        case 'edit':
                            history.push((0, ra_core_1.linkToRecord)(basePath || "/" + resource, id));
                            return [2 /*return*/];
                        case 'show':
                            history.push((0, ra_core_1.linkToRecord)(basePath || "/" + resource, id, 'show'));
                            return [2 /*return*/];
                        case 'expand':
    ...
    return (react_1.default.createElement(ra_core_1.RecordContextProvider, { value: record },
        react_1.default.createElement(core_1.TableRow, __assign({ ref: ref, className: className, key: id, style: style, hover: hover, onClick: handleClick }, rest),
            ...
            react_1.default.Children.map(children, function (field, index) {
                return (0, react_1.isValidElement)(field) ? (react_1.default.createElement(DatagridCell_1.default, __assign({ key: id + "-" + (field.props.source || index), className: (0, classnames_1.default)("column-" + field.props.source, classes.rowCell), record: record }, { field: field, basePath: basePath, resource: resource }))) : null;
            })),
        expandable && expanded && (react_1.default.createElement(core_1.TableRow, { key: id + "-expand", id: id + "-expand", className: classes.expandedPanel },
            react_1.default.createElement(core_1.TableCell, { colSpan: nbColumns }, (0, react_1.isValidElement)(expand)
