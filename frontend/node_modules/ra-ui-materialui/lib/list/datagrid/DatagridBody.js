...
var DatagridBody = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(core_1.TableBody, __assign({ ref: ref, className: (0, classnames_1.default)('datagrid-body', className) }, rest), ids.map(function (id, rowIndex) {
        var _a;
