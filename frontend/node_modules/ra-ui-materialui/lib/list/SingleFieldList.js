...
var SingleFieldList = function (props) {
    ...
    var _c = (0, ra_core_1.useListContext)(props), ids = _c.ids, data = _c.data, loaded = _c.loaded, basePath = _c.basePath;
    ...
    return (React.createElement(Component, __assign({ className: (0, classnames_1.default)(classes.root, className) }, (0, ra_core_1.sanitizeListRestProps)(rest)), ids.map(function (id) {
        var resourceLinkPath = !linkType
            ? false
            : (0, ra_core_1.linkToRecord)(basePath, id, linkType);
        if (resourceLinkPath) {
        ...
        return (React.createElement(ra_core_1.RecordContextProvider, { value: data[id], key: id }, (0, react_1.cloneElement)(react_1.Children.only(children), {
            key: id,
            record: data[id],
            resource: resource,
            basePath: basePath,
