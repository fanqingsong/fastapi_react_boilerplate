...
var useStyles = (0, styles_1.makeStyles)(function (theme) { return ({
    toolbar: {
        ...
        backgroundColor: theme.palette.type === 'light'
            ? (0, colorManipulator_1.lighten)(theme.palette.primary.light, 0.85)
...
var BulkActionsToolbar = function (props) {
    ...
    var _c = (0, ra_core_1.useListContext)(props), basePath = _c.basePath, filterValues = _c.filterValues, resource = _c.resource, selectedIds = _c.selectedIds, onUnselectItems = _c.onUnselectItems;
    var classes = useStyles(props);
    var translate = (0, ra_core_1.useTranslate)();
    return (React.createElement(Toolbar_1.default, __assign({ "data-test": "bulk-actions-toolbar", className: (0, classnames_1.default)(classes.toolbar, (_a = {},
