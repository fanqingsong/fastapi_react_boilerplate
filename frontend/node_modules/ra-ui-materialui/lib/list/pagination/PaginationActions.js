...
var PaginationActions = function (props) {
    ...
    var renderPageNums = function () {
        return range().map(function (pageNum, index) {
            var _a;
            return pageNum === '.' ? (React.createElement("span", { key: "hyphen_" + index, className: classes.hellip }, "\u2026")) : (React.createElement(Button_1.default, { size: size, className: (0, classnames_1.default)('page-number', classes.button, (_a = {},
