...
var Pagination = function (props) {
    ...
    var _a = (0, ra_core_1.useListPaginationContext)(props), loading = _a.loading, page = _a.page, perPage = _a.perPage, total = _a.total, setPage = _a.setPage, setPerPage = _a.setPerPage;
    var translate = (0, ra_core_1.useTranslate)();
    var isSmall = (0, core_1.useMediaQuery)(function (theme) {
    ...
    if (isSmall) {
        return (React.createElement(core_1.TablePagination, __assign({ count: total, rowsPerPage: perPage, page: page - 1, onPageChange: handlePageChange, rowsPerPageOptions: emptyArray, component: "span", labelDisplayedRows: labelDisplayedRows }, (0, ra_core_1.sanitizeListRestProps)(rest))));
    }
    return (React.createElement(core_1.TablePagination, __assign({ count: total, rowsPerPage: perPage, page: page - 1, onPageChange: handlePageChange, onRowsPerPageChange: handlePerPageChange, ActionsComponent: actions, component: "span", labelRowsPerPage: translate('ra.navigation.page_rows_per_page'), labelDisplayedRows: labelDisplayedRows, rowsPerPageOptions: rowsPerPageOptions }, (0, ra_core_1.sanitizeListRestProps)(rest))));
};
