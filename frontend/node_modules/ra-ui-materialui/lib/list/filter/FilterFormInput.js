...
var FilterFormInput = function (props) {
    ...
    return (React.createElement("div", { "data-source": filterElement.props.source, className: (0, classnames_1.default)('filter-field', classes.body) },
        !filterElement.props.alwaysOn && (React.createElement(IconButton_1.default, { className: (0, classnames_1.default)('hide-filter', classes.hideButton), onClick: handleHide, "data-key": filterElement.props.source, title: translate('ra.action.remove_filter') },
