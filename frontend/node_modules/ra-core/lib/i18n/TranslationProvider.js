...
var TranslationProvider = function (props) {
    ...
    var setLocale = (0, react_1.useCallback)(function (newLocale) {
    ...
    var value = (0, react_1.useMemo)(function () { return (__assign(__assign({}, state), { setLocale: setLocale })); }, [setLocale, state]);
