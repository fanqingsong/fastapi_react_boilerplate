...
var useReferenceArrayInputController = function (props) {
    ...
    var _e = (0, util_1.useSafeSetState)(input.value), idsToFetch = _e[0], setIdsToFetch = _e[1];
    var _f = (0, util_1.useSafeSetState)(EmptyArray), idsToGetFromStore = _f[0], setIdsToGetFromStore = _f[1];
    ...
    // filter logic
    var _j = (0, util_1.useSafeSetState)(''), queryFilter = _j[0], setFilter = _j[1];
