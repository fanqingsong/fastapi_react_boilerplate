...
exports.default = (function (_a) {
    ...
    var appReducer = (0, reducer_1.default)(customReducers, history);
    ...
    var saga = function rootSaga() {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, effects_1.all)(__spreadArray([(0, sideEffect_1.adminSaga)(dataProvider, authProvider)], customSagas, true).map(effects_1.fork))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var composeEnhancers = (process.env.NODE_ENV === 'development' &&
        ...
        redux_1.compose;
    var store = (0, redux_1.createStore)(resettableAppReducer, typeof initialState === 'function' ? initialState() : initialState, composeEnhancers((0, redux_1.applyMiddleware)(sagaMiddleware, (0, connected_react_router_1.routerMiddleware)(history))));
