    ...
    return function (action) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 7, , 10]);
                    return [4 /*yield*/, (0, effects_1.put)({ type: authActions_1.USER_LOGIN_LOADING })];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, effects_1.call)([authProvider, 'login'], payload)];
                case 3:
                    authPayload = _a.sent();
                ...
                case 5:
                    redirectTo = _a.sent();
                    return [4 /*yield*/, (0, effects_1.put)((0, connected_react_router_1.push)(redirectTo || '/'))];
                case 6:
                    _a.sent();
                    return [3 /*break*/, 10];
                case 7:
                ...
                case 8:
                    ...
                    return [4 /*yield*/, (0, effects_1.put)((0, notificationActions_1.showNotification)(errorMessage, 'warning'))];
                case 9:
                    _a.sent();
                    return [3 /*break*/, 10];
    ...
    return function (action) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 8]);
                    return [4 /*yield*/, (0, effects_1.call)([authProvider, 'checkAuth'], payload)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 8];
                case 3:
                    error_1 = _a.sent();
                    return [4 /*yield*/, (0, effects_1.call)([authProvider, 'logout'], undefined)];
                case 4:
                    redirectTo = _a.sent();
                    return [4 /*yield*/, (0, effects_1.put)((0, connected_react_router_1.replace)({
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, effects_1.put)((0, clearActions_1.clearState)())];
                case 6:
                    // Clear the state before showing a notification as it would be dismissed immediately otherwise
                    _a.sent();
    ...
    return function (action) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    redirectTo = _a.sent();
                    return [4 /*yield*/, (0, effects_1.put)((0, connected_react_router_1.push)((payload && payload.redirectTo) || redirectTo || '/login'))];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, effects_1.put)((0, clearActions_1.clearState)())];
                case 3:
    ...
    return function (action) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 10]);
                    return [4 /*yield*/, (0, effects_1.call)([authProvider, 'checkError'], error)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 10];
                case 3:
                    e_2 = _a.sent();
                    return [4 /*yield*/, (0, effects_1.select)(currentPathnameSelector)];
                case 4:
                    nextPathname = _a.sent();
                    return [4 /*yield*/, (0, effects_1.call)([authProvider, 'logout'], undefined)];
                case 5:
                    redirectTo = _a.sent();
                    return [4 /*yield*/, (0, effects_1.put)((0, connected_react_router_1.push)({
                ...
                case 7:
                    // Clear the state before showing a notification as it would be dismissed immediately otherwise
                    _a.sent();
                    return [4 /*yield*/, (0, effects_1.put)((0, notificationActions_1.hideNotification)())];
                case 8:
                    _a.sent();
                    return [4 /*yield*/, (0, effects_1.put)((0, notificationActions_1.showNotification)('ra.notification.logged_out', 'warning'))];
                case 9:
                    _a.sent();
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
