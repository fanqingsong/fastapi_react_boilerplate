    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, effects_1.put)((0, notificationActions_1.showNotification)(typeof error === 'string' ? error : error.message || body, level || 'warning', {
                        messageArgs: messageArgs,
                        undoable: false,
                    }))];
            case 1: return [2 /*return*/, _d.sent()];
            case 2: return [4 /*yield*/, (0, effects_1.put)((0, notificationActions_1.showNotification)(body, level || 'info', {
                    messageArgs: messageArgs,
                    undoable: optimistic,
                }))];
            case 3:
...
function default_1() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, effects_1.takeEvery)(
                // @ts-ignore
