    ...
    return function finalize(key, actionCreator) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, (0, effects_1.delay)(50)];
                case 1:
                    // combined with cancel(), this debounces the calls
                    _a.sent();
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, effects_1.cancel)(tasks[key])];
                case 1:
                    _c.sent();
                    _c.label = 2;
                case 2:
                    ...
                    _a = tasks;
                    _b = key;
                    return [4 /*yield*/, (0, effects_1.fork)(finalize, key, action.meta.accumulate)];
                case 3:
                    _a[_b] = _c.sent();
                    return [2 /*return*/];
            }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                accumulations = {};
                tasks = {};
                return [4 /*yield*/, (0, effects_1.takeEvery)(function (action) { return action.meta && action.meta.accumulate; }, (0, exports.accumulateFactory)(tasks, accumulations, (0, exports.finalizeFactory)(tasks, accumulations)))];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
