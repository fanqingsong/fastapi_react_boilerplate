...
var useInput = function (_a) {
    ...
    var _b = (0, react_final_form_1.useField)(finalName, __assign({ initialValue: (0, get_1.default)(record, source, initialValue), defaultValue: defaultValue, validate: sanitizedValidate }, options)), input = _b.input, meta = _b.meta;
